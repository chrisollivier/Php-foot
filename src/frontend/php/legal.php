...
<head>
    ...
    <title>Legal Notices - Random-T</title>
</head>
...
<body>
    ...
    <main>
        ...
        La Société RANDOM-T, SARL, au capital de 70 420 euros, dont le siège social est à VALENCE (26000) 55 Rue du Faubourg Saint-Honoré, immatriculée au registre du commerce et des sociétés de VALENCE sous le numéro 999 999 999 représentée par Monsieur Jorys LOPES (ci-après la " Société ”). La Société commercialise, à ses Clients via son Site Internet, les produits suivants : vêtements.
        <h2 class="h2legal">
            2. Préambule
        </h2>
        ...
        <h2 class="h2legal">3. Définitions</h2>
        ...
        " Site " désigne le présent Site, c’est-à-dire www.random-t.store ;

        " Société " désigne la Société Random-T, plus amplement désignée à l'article I des présentes ; et

        " Utilisateur " désigne toute personne qui fait utilisation du Site.

        <h2 class="h2legal">4. Inscription</h2>
        ...
        <h2 class="h2legal">5. Commandes</h2>
        ...
        <h2 class="h2legal">6. Produits et prix</h2>
        ...
        <h2 class="h2legal">7. Conditions de paiement</h2>
        ...
        <h2 class="h2legal">8. Livraison</h2>
        ...
        <h2 class="h2legal">9. Réclamation</h2>
        ...
        Pour exercer ce droit de réclamation, le Client doit faire parvenir à la Société, à l'adresse randomt@gmail.com , une déclaration dans laquelle il exprime ses réserves et réclamations, assorties des justificatifs y afférents (bordereau de réception contresigné par le transporteur, photographies...)
        ...
        <h2 class="h2legal">10. Droit de rétractation du Consommateur</h2>
        ...
        Pour exercer ce droit de rétractation, le Consommateur envoie une déclaration à l'adresse : randomt@gmail.com .
        ...
        <h2 class="h2legal">11. Transfert des risques et de propriété</h2>
        ...
        <h2 class="h2legal">12. Garanties légales</h2>
        ...
        <h2 class="h2legal">13. Modifications</h2>
        ...
        <h2 class="h2legal">14. Traitement des données personnelles</h2>
        ...
        Par ailleurs, conformément à la loi Informatique et Libertés du 6 janvier 1978, le Client dispose, à tout moment, d'un droit d'interrogation, d'accès, de rectification, de modification et d'opposition à l'ensemble de ses données personnelles en écrivant, par courrier et en justifiant de son identité, à l'adresse suivante : randomt@gmail.com .
        ...
        <h2 class="h2legal">15. Partage des données collectées</h2>
        ...
        <h2 class="h2legal">16. Protection des données</h2>
        ...
        <h2 class="h2legal">17. Cookies</h2>
        ...
        <h2 class="h2legal">18. Responsabilité</h2>
        ...
        <h2 class="h2legal">19. Propriété intellectuelle</h2>
        ...
        <h2 class="h2legal">20. Clause attributive de compétence</h2>
        ...
        <h2 class="h2legal">21. Acceptation des CGV/CGU</h2>
        ...
        <h2 class="h2legal">22. Coordonnées du médiateur</h2>

        Electricité de France (EDF)
        saint marcel les valence, 2 rue des platanes 26320
        </p>
    </main>
