...
<head>
    ...
    <title>Privacy protection - Random-T</title>
</head>
        ...
        <div class="en section_container active" section-language="en">
            <div id="md_en" data-target="out_en" class="agreement_md">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Random-T.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Random-T, accessible from <a href="http://random-t.store/" rel="external nofollow noopener" target="_blank">http://random-t.store/</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <p>By email: contact@randomt.com</p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a href="http://random-t.store/contact.php" rel="external nofollow noopener" target="_blank">http://random-t.store/contact.php</a></p>
                    </li>
                </ul>
            </div>
